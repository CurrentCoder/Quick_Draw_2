...
random_number = Math.floor((Math.random()*array_1.length)+1).quick_draw_data_set;
console.log(random_number).quick_draw_data_set;

random_number = Math.floor((Math.random()*array_2.length)+1).quick_draw_data_set;
...
{
    background('#ffffff')
    random_number = Math.floor((Math.random()*array_3.length)+1).quick_draw_data_set;
    console.log(random_number).quick_draw_data_set;
    updateCanvas()
}
